...
if ($userData) {
    ...
    <head>
        ...
        body {
            ...
            background-image: url('assets/img/questainnaire.jpg'); /* Specify the path to your background image */
...
@keyframes fadeIn {
    ...
    to {
        ...
        .content-container {
            padding: 30px; /* Increased padding for content container */
            border-radius: 20px;
            animation-delay: 2s; /* Increased border radius for content container */
        }
    </style>
                        ...
                        <form id="questionnaireForm" method="get" action="process.php">
                            <div id="questionnaire">
                                <div class="question-container">
                                    <h1 style="font-size: 2.5em;">What course did you pursue in high school?</h1>
                                    <div class="form-check bg-white rounded text-black p-3 pl-5">
                                        <input class="form-check-input ml-1" type="radio" name="highSchoolCourse"
                                            id="science" value="science">
                                        <label style="font-size: 30px" class="form-check-label h6 ml-4" for="science">Science</label>
                                    </div>
                                    <div class="form-check bg-white rounded text-black text-black p-3 mt-2">
                                        <input class="form-check-input ml-1" type="radio" name="highSchoolCourse"
                                            id="commerce" value="commerce">
                                        <label  style="font-size: 30px" class="form-check-label h6 ml-4" for="commerce">Commerce</label>
                                    </div>
                                    <div class="form-check bg-white rounded text-black text-black p-3 mt-2">
                                        <input class="form-check-input ml-1" type="radio" name="highSchoolCourse"
                                            id="humanities" value="humanities">
                                        <label  style="font-size: 30px" class="form-check-label h6 ml-4" for="humanities">Humanities</label>
                                    </div>
                                </div>
                                <div class="question-container mt-5" id="scienceOrEngineering" style="display: none;">
                                    <h1 style="font-size: 2.5em;">Are you interested in pursuing a degree in science or engineering?</h1>
                                    <div class="form-check bg-white rounded text-black text-black p-3">
                                        <input class="form-check-input ml-1" type="radio" name="scienceOrEngineering"
                                            id="scienceDegree" value="science">
                                        <label style="font-size: 30px" class="form-check-label h6 ml-4" for="scienceDegree">Science</label>
                                    </div>
                                    <div class="form-check bg-white rounded text-black text-black p-3 mt-2">
                                        <input class="form-check-input ml-1" type="radio" name="scienceOrEngineering"
                                            id="engineeringDegree" value="engineering">
                                        <label style="font-size: 30px" class="form-check-label h6 ml-4" for="engineeringDegree">Engineering</label>
                                    </div>
                                </div>
                                <div class="card mb-3 question-container bg-light" id="question2" style="display: none;">
                                    <div class="card-body">
                                        ...
                                        <div class="form-check bg-white rounded text-black text-black p-3">
                                            ...
                                            <label  style="font-size: 30px" class="form-check-label h5 ml-4" for="option2-1">Not Interested</label>
                                        </div>
                                        <div class="form-check bg-white rounded text-black text-black p-3 mt-2">
                                            <input class="form-check-input  ml-1" type="radio" name="Database"
                                                id="option2-2" value="option2">
                                            <label  style="font-size: 30px" class="form-check-label h5 ml-4" for="option2-2">Poor</label>
                                        </div>
                                        <div class="form-check bg-white rounded text-black text-black p-3 mt-2">
                                            <input class="form-check-input  ml-1" type="radio" name="Database"
                                                id="option2-3" value="option3">
                                            <label  style="font-size: 30px" class="form-check-label h5 ml-4" for="option2-3">Beginner</label>
                                        </div>
                                        <div class="form-check bg-white rounded text-black text-black p-3 mt-2">
                                            <input class="form-check-input  ml-1" type="radio" name="Database"
                                                id="option2-4" value="option4">
                                            <label  style="font-size: 30px" class="form-check-label h5 ml-4" for="option2-4">Neutral</label>
                                        </div>
                                        <div class="form-check bg-white rounded text-black text-black p-3 mt-2">
                                            <input class="form-check-input  ml-1" type="radio" name="Database"
                                                id="option2-5" value="option5">
                                            <label  style="font-size: 30px" class="form-check-label h5 ml-4" for="option2-5">Modestly Curious</label>
                                        </div>
                                        <div class="form-check bg-white rounded text-black text-black p-3 mt-2">
                                            <input class="form-check-input  ml-1" type="radio" name="Database"
                                                id="option2-6" value="option6">
                                            <label  style="font-size: 30px" class="form-check-label h5 ml-4" for="option2-6">Developing
                                                Interest</label>
                                        </div>
                                        <div class="form-check bg-white rounded text-black text-black p-3 mt-2">
                                            <input  style="font-size: 30px" class="form-check-input  ml-1" type="radio" name="Database"
                                                id="option2-7" value="option7">
                                            <label  style="font-size: 30px" class="form-check-label h5 ml-4" for="option2-7">Profoundly
                                                Interested</label>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5  style="color: black;" class="modal-title" id="validationModalLabel">Please Select an Option</h5>
        ...
        <script>
            ...
            function showQuestion(questionIndex) {
                ...
                for (let i = 0; i < options.length; i++) {
                    ...
                    label.className = "form-check-label h5 ml-4";
                    ...
                    formCheck.className = "form-check bg-white rounded text-black p-3 m-2";
